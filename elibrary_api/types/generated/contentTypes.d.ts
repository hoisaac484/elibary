...
export interface ApiContentContent extends Schema.CollectionType {
  ...
  attributes: {
    TechName: Attribute.String & Attribute.Required & Attribute.Private;
    Document: Attribute.Media<'files'> & Attribute.Required;
    Picture: Attribute.Media<'images', true>;
    Descrption: Attribute.Blocks;
...
export interface ApiDefaultThumbnailDefaultThumbnail extends Schema.SingleType {
...
export interface ApiQuickLinkQuickLink extends Schema.CollectionType {
